...
import com.volvoxmobile.bytedanceagoracrashexample.bytedance.BeautyEffectAdapter;
import com.volvoxmobile.bytedanceagoracrashexample.bytedance.BeautyPageTitleAdapter;
import com.volvoxmobile.bytedanceagoracrashexample.bytedance.ByteDanceBeautyBottomSheetFragment;
import com.volvoxmobile.bytedanceagoracrashexample.bytedance.ByteDanceBeautyBottomSheetFragment_MembersInjector;
import com.volvoxmobile.bytedanceagoracrashexample.bytedance.ByteDanceBeautyBottomSheetViewModel;
import com.volvoxmobile.bytedanceagoracrashexample.bytedance.ByteDanceBeautyBottomSheetViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerHiltApplication_HiltComponents_SingletonC {
  ...
  private static final class FragmentCImpl extends HiltApplication_HiltComponents.FragmentC {
    ...
    @Override
    public void injectByteDanceBeautyBottomSheetFragment(ByteDanceBeautyBottomSheetFragment arg0) {
      injectByteDanceBeautyBottomSheetFragment2(arg0);
    }
    ...
    private ByteDanceBeautyBottomSheetFragment injectByteDanceBeautyBottomSheetFragment2(
        ByteDanceBeautyBottomSheetFragment instance) {
      ByteDanceBeautyBottomSheetFragment_MembersInjector.injectBeautyPageTitleAdapter(instance, new BeautyPageTitleAdapter());
      ByteDanceBeautyBottomSheetFragment_MembersInjector.injectBeautyEffectAdapter(instance, new BeautyEffectAdapter());
      return instance;
    }
  }
  ...
  private static final class ActivityCImpl extends HiltApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return Collections.<String>singleton(ByteDanceBeautyBottomSheetViewModel_HiltModules_KeyModule_ProvideFactory.provide());
    }
  ...
  private static final class ViewModelCImpl extends HiltApplication_HiltComponents.ViewModelC {
    ...
    private Provider<ByteDanceBeautyBottomSheetViewModel> byteDanceBeautyBottomSheetViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.byteDanceBeautyBottomSheetViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.volvoxmobile.bytedanceagoracrashexample.bytedance.ByteDanceBeautyBottomSheetViewModel", ((Provider) byteDanceBeautyBottomSheetViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.volvoxmobile.bytedanceagoracrashexample.bytedance.ByteDanceBeautyBottomSheetViewModel 
          return (T) new ByteDanceBeautyBottomSheetViewModel();
