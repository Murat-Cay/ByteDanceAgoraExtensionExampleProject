 ...
 */
public abstract class Hilt_ByteDanceBeautyBottomSheetFragment<DB extends ViewDataBinding> extends BaseBottomSheetDialogFragment<DB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ByteDanceBeautyBottomSheetFragment_GeneratedInjector) this.generatedComponent()).injectByteDanceBeautyBottomSheetFragment(UnsafeCasts.<ByteDanceBeautyBottomSheetFragment>unsafeCast(this));
    }
  }
